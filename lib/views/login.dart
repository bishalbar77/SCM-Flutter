      ...
      child: Scaffold(
        body: _isLoading
            ...
            : Container(
                ...
                child: Column(
                  crossAxisAlignment:
                      CrossAxisAlignment.start, //position in X-axis
                  children: <Widget>[
                    SizedBox(
                      height: 10,
                    ), //distance from top
                    Padding(
                      padding:
                          EdgeInsets.all(30), //padding from everywhere around
                      child: Column(
                        crossAxisAlignment:
                            CrossAxisAlignment.start, //position in X-axis
                        children: <Widget>[
                          ...
                          SizedBox(
                            height: 10,
                          ), //created a space between these 2 TEXT
                          Text(
                            "Welcome back",
                        ...
                        child: Padding(
                          ...
                          child: ListView(
                            children: <Widget>[
                              SizedBox(
                                height: 40,
                              ), //height of username bar from Expanded
                              Container(
                                decoration: BoxDecoration(
                                    color: Colors.white,
